...
export type RealChatMessage = { id: string; senderId: number; kind: "text" | "image" | "audio"; body: string | null; attachmentUrl: string | null; durationSeconds: number | null; createdAt: Date };
