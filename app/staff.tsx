...
export default function StaffScreen() {
  ...
  const submit = async () => {
    ...
    try {
      await createUser.mutateAsync({ username: username.trim(), name: username.trim(), password });
      setUsername("");
      setPassword("");
