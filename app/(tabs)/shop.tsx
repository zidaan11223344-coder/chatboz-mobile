...
export default function ShopScreen() {
  ...
  const buy = async (productId: string) => {
    try {
      ...
      await owned.refetch();
      Alert.alert("تم التفعيل", "تمت إضافة اللون إلى حسابك مجانًا.");
    } catch (error) {
